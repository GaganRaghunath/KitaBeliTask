...
class OrderItemStatusViewHolder(private val _binding: AdapterOrderItemBinding) :
  ...
  override fun onBind(model: OrderHistoryResponse.OrderItem?) {
    ...
    _binding.statusTv.text = "Produk sedang disiapkan"
    _binding.statusTv.backgroundTintList =
      ContextCompat.getColorStateList(_binding.root.context, R.color.colorCompleted)
